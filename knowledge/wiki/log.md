...
- Hardened Telegram live setup after live smoke-test issues: sanitized accidental angle-bracket chat ids, removed the rejected `tel:` inline URL button in favor of copy-friendly phone text, sent a live demo lead card successfully, and verified `telegram_messages` persistence.
