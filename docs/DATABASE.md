...
- Store masters, assistant profiles, AI numbers, calls, leads, Telegram messages, subscriptions, value reports, and audit logs.
...
- Treat transcripts, recordings, phone numbers, addresses, and raw payloads as sensitive.
