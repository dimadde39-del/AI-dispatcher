...
export const serverEnvSchema = publicEnvSchema.extend({
  ...
  SELF_HOST_VOICE_WEBHOOK_SECRET: optionalSecretSchema,
  LEAD_EXTRACTOR_PROVIDER: z.preprocess(
    (value) => (typeof value === "string" && value.trim() === "" ? undefined : value),
    z.enum(["mock", "deepseek", "openai"]).optional(),
  ),
  LEAD_EXTRACTOR_MODEL: optionalSecretSchema,
...
export function getServerEnv(): ServerEnv {
  ...
  return serverEnvSchema.parse({
    ...
    LEAD_EXTRACTOR_PROVIDER: process.env.LEAD_EXTRACTOR_PROVIDER,
    LEAD_EXTRACTOR_MODEL: process.env.LEAD_EXTRACTOR_MODEL,
